...
<html xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#" lang="en" xml:lang="en">
    ...
    <head>
        ...
        <title>.: Login Again | Blackloop Club :.</title>
                                                                ...
                                                                <div class="col-xs-12">
                                                                            <form action="account/validation" method="post" id="form-login"
                                                                                ...
                                                                                <div class="user-thumb">
                                                                                    <img src="<?php echo $_SESSION['blackloop_slug'][4]; ?>" width="120px" class="img-responsive img-circle img-thumbnail" alt="thumbnail">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <h3 style="font-weight: bold;font-size: 18px;margin-top: 20px;"><?php echo $_SESSION['blackloop_slug'][2]." ".$_SESSION['blackloop_slug'][3]; ?></h3>
                                                                                    <p class="text-muted" style="margin: 10px 0 15px 0;">Re-enter your password to continue.</p>
                                                                                    <div class="form-group">
                                                                                        <div class="col-xs-12">
                                                                                    ...
                                                                                    <div class="form-group form-actions">
                                                                                        ...
                                                                                        <button type="submit" name="login_again" class="hero_button pull-right form-control  input-b" style="margin-top:0px;"><i class="fa fa-angle-right"></i> Proceed</button>
                                                                                            
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="text-center">
                                                                                    <a href="login?x" class="text-muted">Not <?php echo $_SESSION['blackloop_slug'][2]; ?>?</a>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
