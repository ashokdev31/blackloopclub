<?php 
    ...
    if(isset($_POST['change_password']) && isset($_GET['m']) && isset($_GET['x'])){
        ...
        if($password1==$password2){
            ...
            $query = selectPDO("select * from users where email_slug = ? and password = ? and roles is not NULL", array($_GET['m'], $_GET['x']));
            if($query->rowCount()>0){
                otherPDO("update users set password = ?, user_status = '1', date_modified = ? where email_slug = ? and password = ?", array($hash, $date, $_GET['m'], $_GET['x']));
            }
    ...
    if(isset($_GET['m']) && isset($_GET['x'])){
        ...
        $query = selectPDO("select * from users where email_slug = ? and password = ? and roles is not NULL", array($email, $hash));
        if($query->rowCount()==0){
...
<html xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#" lang="en" xml:lang="en">
    ...
    <head>
        ...
        <title>.: Set Admin Password | Blackloop Club :.</title>
                                                                ...
                                                                <div class="col-xs-12">
                                                                            <form action="" method="post" id="form-login"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <p class="text-muted" style="margin: 10px 0 15px 0;">Set Admin Password</p>
                                                                                    <div class="form-group">
                                                                                        <div class="col-xs-12">
