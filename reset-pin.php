<?php 
    ...
    if(isset($_POST['change_pin']) && isset($_GET['m']) && isset($_GET['x'])){
        $pin1 = $_POST['pin1'];
        $pin2 = $_POST['pin2'];
        ...
        if(is_numeric($pin1)){
            if(strlen($pin1)!=4){
                ...
                if($pin1==$pin2){
                    $hash = password_hash($pin1, PASSWORD_BCRYPT);
                    otherPDO("update users set user_pin = ?, date_modified = ? where email_slug = ? and user_pin = ?", array($hash, $date, $_GET['m'], $_GET['x']));
...
<html xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#" lang="en" xml:lang="en">
    ...
    <head>
        ...
        <title>.: Reset PIN | Blackloop Club :.</title>
                                                                ...
                                                                <div class="col-xs-12">
                                                                            <form action="" method="post" id="form-login"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <p class="text-muted" style="margin: 10px 0 15px 0;">Set Transaction PIN</p>
                                                                                    <div class="form-group">
                                                                                        <div class="col-xs-12">
                                                                                            <div class="input-group">
                                                                                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                                                                <input type="password" id="login-password" name="pin1" class="form-control  input-b" placeholder="Enter PIN">
                                                                                        ...
                                                                                        <div class="col-xs-12">
                                                                                            <div class="input-group">
                                                                                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                                                                <input type="password" id="login-password" name="pin2" class="form-control  input-b"
                                                                                    ...
                                                                                    <div class="form-group form-actions">
                                                                                        ...
                                                                                        <button type="submit" name="change_pin" class="hero_button pull-right form-control  input-b" style="margin-top:0px;"><i class="fa fa-angle-right"></i> Confirm</button>
