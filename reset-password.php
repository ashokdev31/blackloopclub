<?php 
    ...
    if(isset($_POST['change_password']) && isset($_GET['m']) && isset($_GET['x'])){
        ...
        if($password1==$password2){
            ...
            $query = selectPDO("select * from users where email_slug = ? and password = ?", array($_GET['m'], $_GET['x']));
            if($query->rowCount()>0){
                otherPDO("update users set password = ?, date_modified = ? where email_slug = ? and password = ?", array($hash, $date, $_GET['m'], $_GET['x']));
            }
    ...
    if(isset($_GET['m']) && isset($_GET['x'])){
        ...
        $query = selectPDO("select * from users where email_slug = ? and password = ?", array($email, $hash));
        if($query->rowCount()==0){
...
<html xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#" lang="en" xml:lang="en">
    ...
    <head>
        ...
        <title>.: Reset Password | Blackloop Club :.</title>
                                                                ...
                                                                <div class="col-xs-12">
                                                                            <form action="" method="post" id="form-login"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <p class="text-muted" style="margin: 10px 0 15px 0;">Set Password</p>
                                                                                    <div class="form-group">
                                                                                        <div class="col-xs-12">
