...
<html xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#" lang="en" xml:lang="en">
    ...
    <head>
        ...
        <title>.: Register as a Sellerator | BlackLoop Club :.</title>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div id="login-container" class="animation-fadeInLeft" data-toggle="animation-appear"
                                                            ...
                                                            <div class="col-xs-12 heading">
                                                                <h1><strong>Become a Sellerator</strong></h1>
                                                                ...
                                                                <form action="payment" method="post" onsubmit="checkValm();" id="form-register"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-6">
                                                                            <input id="referral" name="referral" class="form-control input-b"
                                                                                   ...
                                                                                   type="text" style="display: none;" value="<?php if(isset($_SESSION['referral'])){echo $_SESSION['referral']; unset($_SESSION['referral']);} ?>">
                                                                    ...
                                                                    <div class="col-xs-12" style="padding: 0px;">
                                                                        ...
                                                                        <fieldset>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-xs-12 login">
                                                                                        Not intereted in being a sellerator?
                                                                                        <a style="color:#FE6802" href="register">
                                                                                             <span class="fa fa-angle-double-right"></span> REGISTER AS A MEMBER!
                                                                                        </a>
                                                                                </div>
                                                                            </div>
                                                                        </fieldset>
